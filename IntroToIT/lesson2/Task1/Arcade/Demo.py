...
img_file_hero =     path.dirname(__file__)+ '/Remove-bg.ai_1697117987597.png'
img_file_enemy =    path.dirname(__file__)+ '/Remove-bg.ai_1697117985203.png' 
img_file_bomb =     path.dirname(__file__)+ '/bomb.png'
img_file_princess = path.dirname(__file__)+ '/Remove-bg.ai_1697117982683.png'
FPS = 60
